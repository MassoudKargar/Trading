using Trading.Endpoints.API.Extensions.DependencyInjection.IdentityServer.Options;

namespace Trading.Endpoints.API.Extensions.DependencyInjection.IdentityServer.Extensions;
